...
public class FilmeAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder viewHolder, final int i) {
        ...
        Picasso.get().load(String.valueOf(listaFilmes.get(i).getCapa())).resize(200,200).into(holder.heroiImageView);
    ...
    public static class FilmeViewHolder extends RecyclerView.ViewHolder {
        ...
        public FilmeViewHolder(@NonNull View itemView) {
            ...
            heroiImageView = (ImageView)itemView.findViewById(R.id.heroiView);
        }
